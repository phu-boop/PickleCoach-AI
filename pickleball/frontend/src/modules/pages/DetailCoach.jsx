  ...
  useEffect(() => {
    const getCoach = async () => {
      try {
        ...
        console.log('Fetched coach data:', res);
        setCoach(res.data);
      } catch (err) {
  ...
  return (
    ...
    <div className="mt-30 max-w-6xl mx-auto py-10 px-4 flex flex-col md:flex-row gap-10">
      ...
      <div className="flex-1">
        ...
        <div className="mt-6">
          <h2 className="text-xl font-bold text-[#0a0b3d] mb-2 font-grandstander">Availability</h2>
          <p className="text-gray-700 font-grandstander">
      ...
      <div className="md:w-1/2">
        ...
        <button className="mt-40 bg-[#2d93ad] text-white px-6 py-3 rounded-lg font-bold hover:bg-[#1a6f8c] transition font-grandstander">
          Book a Lesson
        </button>
      </div>
    </div>
