    ...
    <div className="flex justify-between my-10 w-[80%] mx-auto min-h-screen">
      ...
      <div className="p-6 flex-1 bg-white rounded-lg">
        <div className="flex gap-4 mb-6">
          <img className='rounded-xl' src="https://tse2.mm.bing.net/th/id/OIP.9tqEUMM5Ng_G27YF0y4cEAHaDH?pid=Api&P=0&h=220" alt="" />
          <img className='rounded-xl' src="https://tse4.mm.bing.net/th/id/OIP.6E6VEkI2hWmopK4En_eHeQHaEH?pid=Api&P=0&h=220" alt="" />
        </div>
        <div className="mb-6">
          ...
          <div className="mb-4 flex items-center justify-between">
            ...
            <div className="flex items-center">
              ...
              <span className="text-gray-800 font-bold">{user.name || '36 Anh phú'}</span>
            </div>
            <button className="text-teal-600 font-bold hover:underline">Update profile</button>
          </div>
          <div className="mb-4">
            <label className="block text-gray-600 font-bold mb-2">Email addresses</label>
            <div className="flex items-center justify-between">
              <span className="text-gray-800 font-bold">{user.email || 'phudz2502005@gmail.com'}</span>
              <span className="text-teal-600 bg-gray-100 px-2 py-1 rounded font-bold">Primary</span>
              <button className="text-teal-600 font-bold hover:underline">+ Add email address</button>
            </div>
          </div>
          <div className="mb-4">
            <label className="block text-gray-600 font-bold mb-2">Phone numbers</label>
            <button className="text-teal-600 font-bold hover:underline">+ Add phone number</button>
          </div>
          <div>
            <label className="block text-gray-600 font-bold mb-2">Connected accounts</label>
            <div className="flex items-center justify-between">
              ...
              <button className="text-teal-600 font-bold hover:underline">+ Connect account</button>
            </div>
          </div>
        </div>
      </div>
