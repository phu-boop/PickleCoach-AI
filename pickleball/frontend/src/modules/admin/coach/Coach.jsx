                ...
                <tr key={coach.userId} className="border-t border-gray-100 hover:bg-gray-50">
                  ...
                  <td className="py-3 px-4">
                    <ul className="list-disc ml-4">
                      {coach.certifications.map((item, i) => <li key={i}>{item}</li>)}
                    </ul>
                  </td>
                  <td className="py-3 px-4">
                    <ul className="list-disc ml-4">
                      {coach.availability.map((item, i) => <li key={i}>{item}</li>)}
                    </ul>
                  </td>
                  <td className="py-3 px-4">
                    <ul className="list-disc ml-4">
                  ...
                  <td className="py-3 px-4">
                    <button
                      ...
                      className="bg-[#fa8080] cursor-pointer text-white px-4 py-2 rounded-xl text-sm hover:bg-red-600 transition"
                    >
                      Delete
                    </button>
                  </td>
